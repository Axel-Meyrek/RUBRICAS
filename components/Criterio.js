        ...
        `<article class="question" id="criterio${iterador}">
            ...
            <div class="question_botonera">
                <div class="question_flex">
                    ...
                    <button onclick="marcarCriterio('${id}', ${iterador}, 'Sobre el estándar')" class="question_buttonCalification">
                    ...
                    <button onclick="marcarCriterio('${id}', ${iterador}, 'En el estándar')" class="question_buttonCalification">
                ...
                <div class="question_flex">
                    ...
                    <button onclick="marcarCriterio('${id}', ${iterador}, 'Acercándose al estándar')" class="question_buttonCalification">
                ...
                <div class="question_flex">
                    ...
                    <button onclick="marcarCriterio('${id}', ${iterador}, 'Debajo del estándar')" class="question_buttonCalification">
