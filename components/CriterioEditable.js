const CriterioEditable = (idCriterio = -1, numeroCriterio, titulo, ponderacion, descripcion_se, descripcion_e, descripcion_ae, descripcion_de) => {
    return (/* html */
        `<article class="criterio">
            <div class="${numeroCriterio !== '' ? 'criterio_flex' : 'criterio_flex--end'}">
                <p class="criterio_title" ${numeroCriterio !== '' ? numeroCriterio+1 : 'hidden'} >Criterio ${numeroCriterio}</p>
                <button onclick="removeCriterio()" class="criterio_buttonDelete">
            ...
            <input type="hidden" class="criterio_id_editable" value="${idCriterio}">

            <label class="createRubrica_label" for="">Pregunta/Descripción</label>
            <input class="createRubrica_input criterio_titulo_editable" value="${titulo}" type="text" placeholder="Escribe la descripcion o la pregunta de este criterio">
            
            <label class="createRubrica_label" for="">Ponderacion</label>
            <input class="createRubrica_input criterio_ponderacion_editable" value="${ponderacion}" type="text" placeholder="Escribe la ponderacion de este criterio">

            <!-- CRITERIO POINT -->
            <div class="createRubrica_criterioFlex">
                <textarea placeholder="Escribe la descripcion del puntaje correspondiente" class="createRubrica_textarea criterio_se_editable" name="" id="">${descripcion_se}</textarea>
                <p class="createRubrica_criterioPoint">Sobre el estandar</p>
            </div>
            <!-- CRITERIO POINT -->
            <div class="createRubrica_criterioFlex">
                <textarea placeholder="Escribe la descripcion del puntaje correspondiente" class="createRubrica_textarea criterio_e_editable" name="" id="">${descripcion_e}</textarea>
                <p class="createRubrica_criterioPoint">En el estandar</p>
            </div>
            <!-- CRITERIO POINT -->
            <div class="createRubrica_criterioFlex">
                <textarea placeholder="Escribe la descripcion del puntaje correspondiente" class="createRubrica_textarea criterio_ae_editable" name="" id="">${descripcion_ae}</textarea>
                <p class="createRubrica_criterioPoint">Acercandose al estandar</p>
            </div>
            <!-- CRITERIO POINT -->
            <div class="createRubrica_criterioFlex">
                <textarea placeholder="Escribe la descripcion del puntaje correspondiente" class="createRubrica_textarea criterio_de_editable" name="" id="">${descripcion_de}</textarea>
                <p class="createRubrica_criterioPoint">Debajo del estandar</p>
            </div>
        </article>`);
}

export default CriterioEditable;