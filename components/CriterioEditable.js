const CriterioEditable = (numeroCriterio, titulo, ponderacion, descripcion_se, descripcion_e, descripcion_ae, descripcion_de) => {
    return (/* html */
        `<article class="criterio">
            <div class="${numeroCriterio !== undefined ? 'criterio_flex' : 'criterio_flex--end'}">
                <p class="criterio_title" ${numeroCriterio !== undefined ? numeroCriterio+1 : 'hidden'} >Criterio ${numeroCriterio}</p>
